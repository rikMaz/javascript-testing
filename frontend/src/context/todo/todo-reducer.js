  ...
  switch (action.type) {
    ...
    case DELETE_TODO:
      return {
        ...
        todos: state.todos.map((todo) =>
          todo.id === action.id ? { ...todo, deleting: "RUNNING" } : todo
        ),
      };
    ...
    case DELETE_TODO_FAILED:
      return {
        ...state,
        todos: state.todos.map((todo) =>
          todo.id === action.id ? { ...todo, deleting: "FAILED" } : todo
        ),
      };
    case SET_TODO:
      return {
        ...state,
        todos: state.todos.map((todo) =>
          todo.id === action.id ? { ...todo, updating: "RUNNING" } : todo
        ),
      };
    ...
    case SET_TODO_FAILED:
      return {
        ...state,
        todos: state.todos.map((todo) =>
          todo.id === action.id ? { ...todo, updating: "FAILED" } : todo
        ),
      };
    default:
      return state;
